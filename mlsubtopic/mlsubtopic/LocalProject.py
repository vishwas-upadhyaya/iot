...
from mlsubtopic.mlsubtopic.res_gen import get_text

from mlsubtopic.mlsubtopic.TextToSpeech import texttospeech

res = """Generate crisp summary for - In Hindu astrology, seeing a dead snake is important because it means big changes
